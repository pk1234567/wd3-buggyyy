...
!(function (t, e) {
    ...
    n = {
      ...
      arrayDiff: function (t, e) {
        ...
        for (r = 0, i = e.length; r < i; ++r)
          (o = e[r]),
            -1 === (n = a.indexOf(o)) ? l.push([o, 1]) : a.splice(n, 1);
  ...
  var c = {
      ...
      rect: function (t, e) {
        ...
        return (
          t.horizontal
            ? ((n = Math.min(t.x, t.base)), (a = Math.abs(t.base - t.x)))
            : ((o = Math.min(t.y, t.base)), (l = Math.abs(t.base - t.y))),
  ...
  h.extend(_.prototype, {
    _modelize: function (e, r, i, o) {
      ...
      return {
        ...
        positioner:
          ((a = this._el),
          a instanceof t.elements.Arc
            ? c.arc
            : a instanceof t.elements.Point
            ? c.point
            : a instanceof t.elements.Rectangle
            ? c.rect
            : c.fallback),
  ...
  b.extend(M.prototype, {
    ...
    intersects: function (t) {
      ...
      for (
        this._rotation !== t._rotation && a.push(k(o[0], o[1]), k(o[0], o[3])),
          e = 0;
        e < a.length;
        ++e
      )
        if (
          ((r = w(i, a[e])), (n = w(o, a[e])), r.max < n.min || n.max < r.min)
        )
          return !1;
      return !0;
    },
  ...
  var C = {
      ...
      update: function (t) {
        ...
        for (e = 0, r = t.length; e < r; ++e)
          (i = (n = t[e]).model()),
            ((o = n.$layout)._hidable = i && 'auto' === i.display),
            (o._visible = n.visible()),
            (a |= o._hidable);
        a &&
          (function (t) {
            var e, r, n, i, o, a;
            for (e = 0, r = t.length; e < r; ++e)
              (i = (n = t[e]).$layout)._visible &&
                ((o = n.geometry()),
                (a = S(n._el._model, n.model(), o)),
                i._box.update(a, o, n.rotation()));
            (function (t, e) {
              var r, n, i, o;
              for (r = t.length - 1; r >= 0; --r)
                for (i = t[r].$layout, n = r - 1; n >= 0 && i._visible; --n)
                  (o = t[n].$layout)._visible &&
                    i._box.intersects(o._box) &&
                    e(i, o);
            })(t, function (t, e) {
              var r = t._hidable,
                n = e._hidable;
      ...
      draw: function (t, e) {
        ...
        for (r = 0, n = e.length; r < n; ++r)
          (o = (i = e[r]).$layout)._visible &&
            ((a = i.geometry()),
            (l = S(i._el._view, i.model(), a)),
            o._box.update(l, a, i.rotation()),
            i.draw(t, l));
      },
    },
    z = t.helpers,
    ...
    afterEvent: function (e) {
      ...
      (f._dirty || h.length) &&
        ...
        (function (e) {
          if (!e.animating) {
            for (
              var r = t.animationService.animations, n = 0, i = r.length;
              n < i;
              ++n
            )
